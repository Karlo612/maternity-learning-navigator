...
| Low-confidence model presented as certain | Over-trust | Curated fixture matching now; language-specific thresholds and safe refusal before production | Calibration and OOD evaluation | Demo bounded; production open |
